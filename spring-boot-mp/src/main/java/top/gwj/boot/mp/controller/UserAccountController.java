package top.gwj.boot.mp.controller;
...
import top.gwj.boot.mp.common.ApiResponse;
import top.gwj.boot.mp.entity.UserAccount;
import top.gwj.boot.mp.service.UserAccountService;
...
public class UserAccountController {
    ...
    public ApiResponse<IPage<UserAccount>> getUsersPage(@RequestParam(defaultValue = "1") int current, @RequestParam(defaultValue = "10") int size) {
        IPage<UserAccount> page = new Page<>(current, size);
