package top.gwj.boot.config.model;
...
import top.gwj.boot.config.service.MailService;
...
class MailServiceTest {
    ...
    void sendAttachmentsMail() throws Exception {
        ...
        // 本地文件
        File file1 = new File("/E:/南工作业/web作业/1.jpg");
        File file2 = new File("/E:/南工作业/web作业/aaa.png");
