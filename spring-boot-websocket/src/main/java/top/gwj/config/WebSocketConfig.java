...
import top.gwj.handler.DeviceMonitorWebSocketHandler;
import top.gwj.handler.SimpleTimeWebSocketHandler;
import top.gwj.handler.TestWebSocketHandler;
...
public class WebSocketConfig implements WebSocketConfigurer {
    ...
    public void registerWebSocketHandlers(WebSocketHandlerRegistry registry) {
        ...
        // 在WebSocketConfig的registerWebSocketHandlers方法中添加
